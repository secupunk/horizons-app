  ...
  const generateAIContent = async (route1, route2) => {
    ...
    try {
      ...
      setAiContent({
        ...
        fun_fact_1: `The ${route1.city} heart is a masterpiece of symmetry.`,
        fun_fact_2: `Running in ${route2.city} is the ultimate cardio test.`,
        recommendation: "Both routes are absolute GPS art!",
